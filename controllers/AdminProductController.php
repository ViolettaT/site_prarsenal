...
class AdminProductController extends AdminBase
{
    ...
    public function actionCreate()
    {
		...
		// Подключаем вид
        	require_once(ROOT . '/views/admin_product/report.php');
        	return true;
            }
        }
    ...
    public function actionUpdate($id)
    {
	    ...
	    // Подключаем вид
            require_once(ROOT . '/views/admin_product/report_up.php');
            return true;
        }
    ...
    public function actionDelete($id)
    {
        ...
        if (isset($_POST['submit'])) {
	     ...
	     // Подключаем вид
             require_once(ROOT . '/views/admin_product/report_del.php');
             return true;
        }
